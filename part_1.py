...
class Operations:
	...
	# rotation matrices for converting 3D points to 2D
...
class Shape:
	'''
	Class for storing, manipulating, and rendering given shape
	'''
	...
	def initialize_edges(self):
		...
		Treats anti-parallel edges as separate, but does not affect rendering
		'''
	...
	def render(self):
		...
		pygame.display.set_caption('Wireframe Rendering')
		...
		while True:
			...
			for u, v in self.edges:
				pygame.draw.line(window, (0, 0, 255), (points[u][0], points[u][1]) , (points[v][0], points[v][1]))
				pygame.draw.circle(window, (100, 100, 255), points[u], 5)
				pygame.draw.circle(window, (100, 100, 255), points[v], 5)
